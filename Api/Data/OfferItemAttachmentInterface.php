...
/**
 * Offer Item Attachment interface
 */
interface OfferItemAttachmentInterface
{
    /**
     * const for keys of data array. Identical to the name of the getter in snake case
     */
    public const string CACHE_TAG = 'offer_item_attachment';
    public const string ATTACHMENT_ID = 'attachment_id';
    public const string OFFER_ITEMS_ID = 'offer_items_id';
     ...
     * @return $this
     */
    public function setOfferItemsId(int $offerItemsId): self;
